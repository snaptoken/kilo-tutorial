...
the column number at which to position the cursor. So if you have an `80x24`
size terminal and you want the cursor in the center of the screen, you could
...
`[` character, and then the actual response: `35;115R`, or similar. (This
